    ...
    return (
      <div>
        <nav className="navbar navbar-expand navbar-dark bg-dark static-top">
          ...
          <Link className="navbar-brand mr-1" to="/admin">Admin Site</Link>
          ...
          <ul className="navbar-nav ml-auto ml-md-0">
            <li className="nav-item dropdown no-arrow">
              ...
              <div className="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                <button className="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal" onClick={this.onLogOut}>Logout</button>
              </div>
            </li>
          </ul>
        </nav>
...
export default withRouter(AdHeader);
